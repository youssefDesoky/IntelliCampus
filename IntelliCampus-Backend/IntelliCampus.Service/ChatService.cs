...
public class ChatService : IChatService
{
    ...
    private async Task<ChatMessageDto> MapToDtoAsync(ChatMessage m)
    {
        ...
        return new ChatMessageDto
        {
            ...
            SenderId = m.SenderId,
            SenderName = sender?.FullName ?? (m.SenderId == FahimSenderId ? "Faheem" : null),
            RecipientId = m.RecipientId,
            RecipientName = recipient?.FullName ?? (m.RecipientId == FahimSenderId ? "Faheem" : null),
