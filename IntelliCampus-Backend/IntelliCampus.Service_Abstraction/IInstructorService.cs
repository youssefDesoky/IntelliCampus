...
public interface IInstructorService
{
    ...
    Task<IEnumerable<InstructorDto>> GetInstructorsForLoanAsync(int facultyId);
    Task<InstructorDto> LoanInstructorAsync(int instructorId, UpdateInstructorDto dto);
